...
export interface OpenADEReadAdapter {
	...
	readProjects(options?: { workingTaskIds?: string[] }): Promise<
		OpenADEProject[]
	>;
	readTaskList(
		repoId: string,
		options?: { workingTaskIds?: string[] },
	): Promise<OpenADETaskPreview[]>;
	readTask(
		repoId: string,
		taskId: string,
...
export interface OpenADEWriteAdapter {
	...
	createRepo(
		params: OpenADERepoCreateRequest,
	): Promise<OpenADERepoCreateResult>;
	updateRepo(params: OpenADERepoUpdateRequest): Promise<unknown>;
	deleteRepo(params: OpenADERepoDeleteRequest): Promise<unknown>;
	createTask(
		params: OpenADETaskCreateRequest,
	): Promise<OpenADETaskCreateResult>;
	startTurn(
	...
	enqueueQueuedTurn(
		params: OpenADEQueuedTurnEnqueueRequest,
	): Promise<OpenADEQueuedTurnEnqueueResult>;
	reorderQueuedTurns(
		params: OpenADEQueuedTurnReorderRequest,
	): Promise<OpenADEQueuedTurnReorderResult>;
	cancelQueuedTurn(
		params: OpenADEQueuedTurnCancelRequest,
	): Promise<OpenADEQueuedTurnCancelResult>;
	deleteTask(
		params: OpenADETaskDeleteRequest,
	): Promise<OpenADETaskDeleteResult>;
	setupTaskEnvironment(
		params: OpenADETaskEnvironmentSetupRequest,
	): Promise<unknown>;
	createActionEvent(params: OpenADEActionEventCreateRequest): Promise<unknown>;
	appendActionStreamEvent(
		params: OpenADEActionStreamAppendRequest,
	): Promise<unknown>;
	completeActionEvent(
		params: OpenADEActionEventCompleteRequest,
	): Promise<unknown>;
	errorActionEvent(params: OpenADEActionEventErrorRequest): Promise<unknown>;
	stoppedActionEvent(
		params: OpenADEActionEventStoppedRequest,
	): Promise<unknown>;
	reconcileActionEventRuntime(
		params: OpenADEActionEventRuntimeReconcileRequest,
	): Promise<OpenADEActionEventRuntimeReconcileResult>;
	updateActionExecution(
		params: OpenADEActionExecutionUpdateRequest,
	): Promise<unknown>;
	addHyperPlanSubExecution(
		params: OpenADEHyperPlanSubExecutionAddRequest,
	): Promise<unknown>;
	appendHyperPlanSubExecutionStreamEvent(
		params: OpenADEHyperPlanSubExecutionStreamAppendRequest,
	): Promise<unknown>;
	updateHyperPlanSubExecution(
		params: OpenADEHyperPlanSubExecutionUpdateRequest,
	): Promise<unknown>;
	setHyperPlanReconcileLabels(
		params: OpenADEHyperPlanReconcileLabelsSetRequest,
	): Promise<unknown>;
	createSnapshotEvent(
		params: OpenADESnapshotEventCreateRequest,
	): Promise<OpenADESnapshotEventCreateResult>;
	...
	updateTaskMetadata(
		params: OpenADETaskMetadataUpdateRequest,
	): Promise<unknown>;
	writeTaskImage?(
		params: OpenADETaskImageWriteRequest,
	): Promise<OpenADETaskImageWriteResult>;
	readStagedTaskImage?(
		params: OpenADETaskImageStagedReadRequest,
	): Promise<OpenADETaskImageStagedReadResult>;
}
...
export interface OpenADEModuleAdapters
	extends OpenADEReadAdapter,
		OpenADEWriteAdapter {
	...
	replaceMcpServers?: (
		params: OpenADEMCPServersReplaceRequest,
	) => Promise<OpenADEMCPServersReplaceResult>;
	upsertMcpServer?: (
		params: OpenADEMCPServerUpsertRequest,
	) => Promise<OpenADEMCPServerUpsertResult>;
	deleteMcpServer?: (
		params: OpenADEMCPServerDeleteRequest,
...
function validateWith(parse: (params: unknown) => unknown) {
	return (params: unknown): RuntimeValidationResult<unknown> => {
		try {
			...
			const message =
				error instanceof Error ? error.message : "OpenADE params are invalid";
			return {
				ok: false,
				error: {
					code: "invalid_params",
...
function stableClientRequestKey(params: unknown): string | undefined {
	...
	return typeof clientRequestId === "string" && clientRequestId.length > 0
		? clientRequestId
		: undefined;
}
...
function stringParamAllowEmpty(
...
function optionalStrictStringArrayParam(
	record: Record<string, unknown>,
	key: string,
): string[] | undefined {
	const value = record[key];
...
function optionalIsoTimestampParam(
	record: Record<string, unknown>,
	key: string,
): string | undefined {
...
function scopedRelativePathParam(
	record: Record<string, unknown>,
	key: string,
): string {
...
function optionalScopedRelativePathParam(
	record: Record<string, unknown>,
	key: string,
): string {
	const value = record[key];
...
function projectFilesTreeParams(
	params: unknown,
): OpenADEProjectFilesTreeRequest {
...
function projectFileWriteParams(
	params: unknown,
): OpenADEProjectFileWriteRequest {
	const record = asRecord(params);
	const encoding = record.encoding === "base64" ? "base64" : "utf8";
...
function projectFilesFuzzySearchParams(
	params: unknown,
): OpenADEProjectFilesFuzzySearchRequest {
	const record = asRecord(params);
	return {
...
function projectGitBranchesReadParams(
	params: unknown,
): OpenADEProjectGitBranchesReadRequest {
	const record = asRecord(params);
	return {
...
function projectGitSummaryReadParams(
	params: unknown,
): OpenADEProjectGitSummaryReadRequest {
	const record = asRecord(params);
	return {
...
function projectProcessListParams(
	params: unknown,
): OpenADEProjectProcessListRequest {
	const record = asRecord(params);
	return {
...
function cronDefinitionsReadParams(
	params: unknown,
): OpenADECronDefinitionsReadRequest {
	const record = asRecord(params);
	return {
...
function cronDefinitionsFromProcessList(
...
function projectProcessStartParams(
	params: unknown,
): OpenADEProjectProcessStartRequest {
	const record = asRecord(params);
	return {
...
function projectProcessReconnectParams(
	params: unknown,
): OpenADEProjectProcessReconnectRequest {
	const record = asRecord(params);
	return {
...
function projectProcessStopParams(
	params: unknown,
): OpenADEProjectProcessStopRequest {
	const record = asRecord(params);
	return {
...
function cronInstallStateReadParams(
	params: unknown,
): OpenADECronInstallStateReadRequest {
	const record = asRecord(params);
	return {
...
function cronInstallStateParam(
	key: string,
	value: unknown,
): OpenADECronInstallState {
...
function cronInstallStateInstallationsParam(
	value: unknown,
...
function cronInstallStateReplaceParams(
	params: unknown,
): OpenADECronInstallStateReplaceRequest {
	const record = asRecord(params);
	return {
...
function taskTerminalStartParams(
	params: unknown,
): OpenADETaskTerminalStartRequest {
	const record = asRecord(params);
	return {
...
function taskTerminalReconnectParams(
	params: unknown,
): OpenADETaskTerminalReconnectRequest {
	const record = asRecord(params);
	return {
...
function taskTerminalWriteParams(
	params: unknown,
): OpenADETaskTerminalWriteRequest {
	const record = asRecord(params);
	return {
...
function taskTerminalResizeParams(
	params: unknown,
): OpenADETaskTerminalResizeRequest {
	const record = asRecord(params);
	return {
...
function taskTerminalStopParams(
	params: unknown,
): OpenADETaskTerminalStopRequest {
	const record = asRecord(params);
	return {
...
const ALLOWED_TASK_IMAGE_EXTENSIONS = new Set([
	"gif",
	"jpeg",
	"jpg",
	"png",
...
function taskImageExtParam(
	record: Record<string, unknown>,
	key: string,
): string {
	const value = stringParam(record, key).toLowerCase();
	if (!ALLOWED_TASK_IMAGE_EXTENSIONS.has(value))
		throw new Error(`${key} is invalid`);
	return value;
}

function taskImageWriteExtParam(
	record: Record<string, unknown>,
	key: string,
): TaskImageWriteExt {
	const value = stringParam(record, key).toLowerCase();
...
function expectedImageMediaType(
	ext: TaskImageWriteExt,
): TaskImageWriteMediaType {
	switch (ext) {
		case "gif":
			return "image/gif";
		case "jpeg":
...
function taskImageWriteMediaTypeParam(
	record: Record<string, unknown>,
	key: string,
	ext: TaskImageWriteExt,
): TaskImageWriteMediaType {
...
function taskImageStagedReadParams(
	params: unknown,
): OpenADETaskImageStagedReadRequest {
	const record = asRecord(params);
	return {
...
function taskGitScopesReadParams(
	params: unknown,
): OpenADETaskGitScopesReadRequest {
	const record = asRecord(params);
	return {
...
function taskResourceInventoryReadParams(
	params: unknown,
): OpenADETaskResourceInventoryReadRequest {
	const record = asRecord(params);
	return {
...
function taskUsageRecalculateParams(
	params: unknown,
): OpenADETaskUsageRecalculateRequest {
	const record = asRecord(params);
	return {
...
function taskUsageBackfillParams(
	params: unknown,
): OpenADETaskUsageBackfillRequest {
	const record = asRecord(params);
	return {
...
function taskTitleGenerateParams(
	params: unknown,
): OpenADETaskTitleGenerateRequest {
	const record = asRecord(params);
	return {
...
function taskDiffContextLinesParam(
	value: unknown,
): OpenADETaskDiffContextLines {
...
function taskFilePairReadParams(
	params: unknown,
): OpenADETaskFilePairReadRequest {
	const record = asRecord(params);
	return {
...
function optionalTaskGitScopeIdParam(
	record: Record<string, unknown>,
	key: string,
): string | undefined {
	const value = record[key];
	...
	if (!/^(branch|worktree):[A-Za-z0-9._/@-]+$/.test(trimmed))
		throw new Error(`${key} is invalid`);
	return trimmed;
}
...
function strictStringRecordParam(
	value: unknown,
	key: string,
	...
	for (const [nestedKey, nested] of Object.entries(record)) {
		if (typeof nested !== "string")
			throw new Error(`${key}.${nestedKey} is invalid`);
		result[nestedKey] = nested;
	}
	return result;
}

function mcpOAuthTokensParam(
	value: unknown,
): OpenADEMCPOAuthTokens | undefined {
	if (value === undefined) return undefined;
	const record = asRecord(value);
	return {
...
function mcpServersReplaceParams(
	params: unknown,
): OpenADEMCPServersReplaceRequest {
	const record = asRecord(params);
...
function personalSettingsThemeParam(
	value: unknown,
): OpenADEPersonalSettingsThemeSetting {
	switch (value) {
		case undefined:
...
function personalSettingsTabParam(
	record: Record<string, unknown>,
	key: string,
): OpenADEPersonalSettingsTab | undefined {
	const value = record[key];
	switch (value) {
		case undefined:
			return undefined;
...
function personalSettingsAgentCoupletParam(
	value: unknown,
	key: string,
): OpenADEAgentCouplet {
	try {
...
function personalSettingsAgentCoupletsParam(
	value: unknown,
	key: string,
): OpenADEAgentCouplet[] | undefined {
	if (value === undefined) return undefined;
	if (!Array.isArray(value)) throw new Error(`${key} is invalid`);
	return value.map((item, index) =>
		personalSettingsAgentCoupletParam(item, `${key}.${index}`),
	);
}

function optionalPersonalSettingsAgentCoupletParam(
	value: unknown,
	key: string,
): OpenADEAgentCouplet | undefined {
	if (value === undefined) return undefined;
...
function personalSettingsParam(value: unknown): OpenADEPersonalSettings {
	...
	return {
		...
		renderMarkdownMessages:
			booleanParam(record, "renderMarkdownMessages") ?? true,
		lastSeenReleaseVersion: optionalStringParam(
			record,
		...
		hyperplanAgents: personalSettingsAgentCoupletsParam(
			record.hyperplanAgents,
			"hyperplanAgents",
		),
		hyperplanReconciler: optionalPersonalSettingsAgentCoupletParam(
			record.hyperplanReconciler,
			"hyperplanReconciler",
		),
	};
}

function personalSettingsReplaceParams(
	params: unknown,
): OpenADEPersonalSettingsReplaceRequest {
	const record = asRecord(params);
	return {
...
function taskGitCommitFilesParams(
	params: unknown,
): OpenADETaskGitCommitFilesRequest {
	const record = asRecord(params);
	return {
...
function taskGitFileAtTreeishParams(
	params: unknown,
): OpenADETaskGitFileAtTreeishRequest {
	const record = asRecord(params);
	return {
...
function taskGitCommitFilePatchParams(
	params: unknown,
): OpenADETaskGitCommitFilePatchRequest {
	const record = asRecord(params);
	return {
...
function taskSnapshotPatchReadParams(
	params: unknown,
): OpenADETaskSnapshotPatchReadRequest {
	const record = asRecord(params);
	return {
...
function taskSnapshotIndexReadParams(
	params: unknown,
): OpenADETaskSnapshotIndexReadRequest {
	return taskSnapshotPatchReadParams(params);
}

function taskSnapshotPatchSliceReadParams(
	params: unknown,
): OpenADETaskSnapshotPatchSliceReadRequest {
	const record = asRecord(params);
...
function hyperplanStrategyParam(
	value: unknown,
): OpenADEHyperPlanStrategy | undefined {
	if (value === undefined) return undefined;
	const record = asRecord(value);
	const stepsValue = record.steps;
	if (!Array.isArray(stepsValue))
		throw new Error("hyperplanStrategy.steps is invalid");
...
function gitRefsParam(
	value: unknown,
): OpenADEActionEventCreateRequest["gitRefsBefore"] {
	if (value === undefined) return undefined;
	const record = asRecord(value);
	if (typeof record.sha !== "string" || record.sha.length < 1)
		throw new Error("gitRefsBefore.sha is invalid");
	return {
		sha: record.sha,
...
function taskImageReferences(value: unknown): OpenADETaskImageReference[] {
	...
	return value
		.map(taskImageReference)
		.filter((image): image is OpenADETaskImageReference => image !== null);
}

function taskImageReferenceForTask(
	task: OpenADETask,
	imageId: string,
	ext: string,
): OpenADETaskImageReference | null {
...
function snapshotEventForTask(
	task: OpenADETask,
	eventId: string,
): OpenADESnapshotEventRecord {
	for (const event of task.events) {
		const record = eventRecord(event);
		if (record?.type === "snapshot" && record.id === eventId)
			return record as OpenADESnapshotEventRecord;
	}
...
function taskCreateParams(params: unknown): OpenADETaskCreateRequest {
	...
	return {
		...
		createdAt: optionalStringParam(record, "createdAt"),
		isolationStrategy:
			record.isolationStrategy === undefined
				? undefined
				: (record.isolationStrategy as OpenADETaskCreateRequest["isolationStrategy"]),
		enabledMcpServerIds: stringArrayParam(record, "enabledMcpServerIds"),
		deviceEnvironment:
			record.deviceEnvironment === undefined
				? undefined
				: taskDeviceEnvironmentParam(record.deviceEnvironment),
		setupEvent:
			record.setupEvent === undefined
				? undefined
				: setupEnvironmentEventParam(record.setupEvent),
		clientRequestId: optionalStringParam(record, "clientRequestId"),
	};
}
...
function turnParams(params: unknown): OpenADETurnStartRequest {
	...
	if (typeof repoId !== "string" || repoId.length < 1)
		throw new Error("repoId is invalid");
	if (typeof input !== "string" || input.length > 200_000)
		throw new Error("input is invalid");
	const isExistingTurn =
		typeof record.inTaskId === "string" && record.inTaskId.length > 0;
	if (!isExistingTurn && input.trim().length < 1)
		throw new Error("input is invalid");
	if (
		record.type !== "plan" &&
		record.type !== "do" &&
	...
	return {
		...
		clientRequestId:
			typeof record.clientRequestId === "string"
				...
				: undefined,
		appendSystemPrompt:
			typeof record.appendSystemPrompt === "string"
				? record.appendSystemPrompt
				: undefined,
		inTaskId:
			record.inTaskId === null
				? null
				: typeof record.inTaskId === "string"
					? record.inTaskId
					: undefined,
		isolationStrategy:
			record.isolationStrategy as OpenADETurnStartRequest["isolationStrategy"],
		enabledMcpServerIds: Array.isArray(record.enabledMcpServerIds)
			? record.enabledMcpServerIds.filter(
					(id): id is string => typeof id === "string",
				)
			: undefined,
		harnessId:
			typeof record.harnessId === "string" ? record.harnessId : undefined,
		modelId: typeof record.modelId === "string" ? record.modelId : undefined,
		label: typeof record.label === "string" ? record.label : undefined,
		includeComments:
			typeof record.includeComments === "boolean"
...
function reviewStartParams(params: unknown): OpenADEReviewStartRequest {
	...
	if (record.reviewType !== "plan" && record.reviewType !== "work")
		throw new Error("reviewType is invalid");
	if (typeof harnessId !== "string" || harnessId.length < 1)
		throw new Error("harnessId is invalid");
	if (typeof modelId !== "string" || modelId.length < 1)
...
function actionSourceParam(
	value: unknown,
): OpenADEActionEventCreateRequest["source"] {
	...
	if (typeof source.userLabel !== "string" || source.userLabel.length < 1)
		throw new Error("source.userLabel is invalid");
	return source as OpenADEActionEventCreateRequest["source"];
}

function createActionEventParams(
	params: unknown,
): OpenADEActionEventCreateRequest {
	const record = asRecord(params);
...
function appendActionStreamEventParams(
	params: unknown,
): OpenADEActionStreamAppendRequest {
	const record = asRecord(params);
	const streamEvent = asRecord(record.streamEvent);
	const streamEventId = streamEvent.id;
	if (typeof streamEventId !== "string" || streamEventId.length < 1)
		throw new Error("streamEvent.id is invalid");
	return {
		taskId: stringParam(record, "taskId"),
		eventId: stringParam(record, "eventId"),
...
function completeActionEventParams(
	params: unknown,
): OpenADEActionEventCompleteRequest {
	const record = asRecord(params);
...
function errorActionEventParams(
	params: unknown,
): OpenADEActionEventErrorRequest {
	const record = asRecord(params);
	return {
...
function stoppedActionEventParams(
	params: unknown,
): OpenADEActionEventStoppedRequest {
	const record = asRecord(params);
	return {
...
function reconcileActionEventRuntimeParams(
	params: unknown,
): OpenADEActionEventRuntimeReconcileRequest {
	const record = asRecord(params);
...
function actionExecutionUpdateParams(
	params: unknown,
): OpenADEActionExecutionUpdateRequest {
	const record = asRecord(params);
	return {
...
function hyperplanSubExecutionParam(
	value: unknown,
): OpenADEHyperPlanSubExecutionAddRequest["subExecution"] {
	const record = asRecord(value);
	...
	return {
		...
		events: Array.isArray(record.events)
			? record.events.map(streamEventParam)
			: [],
...
function hyperplanSubExecutionAddParams(
	params: unknown,
): OpenADEHyperPlanSubExecutionAddRequest {
	const record = asRecord(params);
	return {
...
function hyperplanSubExecutionStreamAppendParams(
	params: unknown,
): OpenADEHyperPlanSubExecutionStreamAppendRequest {
	const record = asRecord(params);
	return {
...
function hyperplanSubExecutionUpdateParams(
	params: unknown,
): OpenADEHyperPlanSubExecutionUpdateRequest {
	const record = asRecord(params);
	const status = record.status;
...
function hyperplanReconcileLabelsSetParams(
	params: unknown,
): OpenADEHyperPlanReconcileLabelsSetRequest {
	const record = asRecord(params);
...
function snapshotStatsParam(
	value: unknown,
): OpenADESnapshotEventCreateRequest["stats"] {
	const record = asRecord(value);
	return {
...
function snapshotFilesParam(
	value: unknown,
): OpenADESnapshotEventCreateRequest["files"] {
...
function snapshotEventCreateParams(
	params: unknown,
): OpenADESnapshotEventCreateRequest {
	const record = asRecord(params);
	return {
...
function selectedTextParam(
	value: unknown,
): OpenADECommentCreateRequest["selectedText"] {
	const record = asRecord(value);
	return {
		text: typeof record.text === "string" ? record.text : "",
		linesBefore:
			typeof record.linesBefore === "string" ? record.linesBefore : "",
...
function taskMetadataUpdateParams(
	params: unknown,
): OpenADETaskMetadataUpdateRequest {
	const record = asRecord(params);
	return {
...
function taskDeviceEnvironmentParam(
	value: unknown,
): OpenADETaskEnvironmentSetupRequest["deviceEnvironment"] {
	const record = asRecord(value);
	const setupComplete = record.setupComplete;
	if (typeof setupComplete !== "boolean")
		throw new Error("deviceEnvironment.setupComplete is invalid");
	return {
		id: stringParam(record, "id"),
		deviceId: stringParam(record, "deviceId"),
...
function setupEnvironmentEventParam(
	value: unknown,
): OpenADETaskEnvironmentSetupRequest["setupEvent"] {
	if (value === undefined) return undefined;
	const record = asRecord(value);
	return {
		taskId: optionalStringParam(record, "taskId"),
...
function taskEnvironmentSetupParams(
	params: unknown,
): OpenADETaskEnvironmentSetupRequest {
	const record = asRecord(params);
	return {
...
function taskEnvironmentPrepareParams(
	params: unknown,
): OpenADETaskEnvironmentPrepareRequest {
	const record = asRecord(params);
	return {
...
function legacyResourcesImportParams(
	params: unknown,
): OpenADELegacyResourcesImportRequest {
	const record = asRecord(params);
	...
	if (
		...
		throw new Error(
			"dataDir, imageDir, snapshotDir, importSessions, claudeConfigDir, or codexHome is required",
		);
	}
	return request;
}
...
function queuedTurnCancelParams(
	params: unknown,
): OpenADEQueuedTurnCancelRequest {
	const record = asRecord(params);
	return {
...
function queuedTurnEnqueueParams(
	params: unknown,
): OpenADEQueuedTurnEnqueueRequest {
	const record = asRecord(params);
	...
	return {
		...
		enabledMcpServerIds: optionalStrictStringArrayParam(
			record,
			"enabledMcpServerIds",
		),
		harnessId: optionalStringParam(record, "harnessId"),
...
function queuedTurnReorderParams(
	params: unknown,
): OpenADEQueuedTurnReorderRequest {
	const record = asRecord(params);
	const queuedTurnIds = optionalStrictStringArrayParam(record, "queuedTurnIds");
	if (!queuedTurnIds || queuedTurnIds.length < 1)
		throw new Error("queuedTurnIds is invalid");
	if (new Set(queuedTurnIds).size !== queuedTurnIds.length)
		throw new Error("queuedTurnIds must be unique");
	return {
		repoId: stringParam(record, "repoId"),
		taskId: stringParam(record, "taskId"),
		queuedTurnIds,
...
export function createOpenADEModule(
	adapters: OpenADEModuleAdapters,
): RuntimeModule {
	const clientRequests = new Map<string, ClientRequestEntry>();
	const createId = adapters.createId ?? createFallbackId;
	const clientRequestRetentionMs =
		adapters.clientRequestRetentionMs ?? DEFAULT_CLIENT_REQUEST_RETENTION_MS;
	...
	return {
		...
		register(server) {
			...
			server.register(
				"openade/task/read",
				(params) => {
					const { repoId, taskId, hydrateSessionEvents } =
			...
			if (writeTaskImage) {
				server.register(
					...
					(params) =>
						runIdempotentMutation("openade/task/image/write", params, () =>
							writeTaskImage(taskImageWriteParams(params)),
						),
			...
			if (scopedHost) {
				...
				server.register(
					...
					async (params) => {
						...
						const { repo, task } = await readScopedProjectOptionalTask(
							request.repoId,
							request.taskId,
						);
				...
				server.register(
					...
					async (params) => {
						...
						return runIdempotentMutation(
							"openade/project/file/write",
							params,
							() => scopedHost.writeProjectFile({ ...request, repo, task }),
						);
					},
				...
				server.register(
					...
					async (params) => {
						...
						return runIdempotentMutation(
							"openade/project/process/stop",
							params,
							() => scopedHost.stopProjectProcess({ ...request, repo, task }),
						);
					},
				...
				server.register(
					...
					async (params) => {
						...
						const { repo, task } = await readScopedProjectTask(
							request.repoId,
							request.taskId,
						);
						return runIdempotentMutation(
							"openade/task/terminal/start",
							params,
							() => scopedHost.startTaskTerminal({ ...request, repo, task }),
						);
					},
				...
				server.register(
					...
					async (params) => {
						...
						return runIdempotentMutation(
							"openade/task/terminal/write",
							params,
							() => scopedHost.writeTaskTerminal({ ...request, repo, task }),
						);
					},
				...
				server.register(
					...
					async (params) => {
						...
						return runIdempotentMutation(
							"openade/task/terminal/resize",
							params,
							() => scopedHost.resizeTaskTerminal({ ...request, repo, task }),
						);
					},
				...
				server.register(
					...
					async (params) => {
						...
						return runIdempotentMutation(
							"openade/task/terminal/stop",
							params,
							() => scopedHost.stopTaskTerminal({ ...request, repo, task }),
						);
					},
				...
				server.register(
					...
					async (params) => {
						...
						const image = taskImageReferenceForTask(
							task,
							request.imageId,
							request.ext,
						);
				...
				server.register(
					...
					async (params) => {
						...
						return runIdempotentMutation(
							"openade/task/git/commit",
							params,
							() => scopedHost.commitTaskGit({ ...request, repo, task }),
						);
					},
				...
				server.register(
					...
					async (params, context) => {
						...
						const isRunning = activeOpenADETaskIds(context.server).includes(
							task.id,
						);
			...
			server.register(
				"openade/repo/create",
				(params) =>
					runIdempotentMutation("openade/repo/create", params, () =>
						adapters.createRepo(repoCreateParams(params)),
					),
				{
			...
			server.register(
				"openade/repo/update",
				(params) =>
					runIdempotentMutation("openade/repo/update", params, () =>
						adapters.updateRepo(repoUpdateParams(params)),
					),
				{
			...
			server.register(
				"openade/repo/delete",
				(params) =>
					runIdempotentMutation("openade/repo/delete", params, () =>
						adapters.deleteRepo(repoDeleteParams(params)),
					),
				{
			...
			server.register(
				"openade/task/create",
				(params) =>
					runIdempotentMutation("openade/task/create", params, () =>
						adapters.createTask(taskCreateParams(params)),
					),
				{
			...
			server.register(
				...
				(params) => {
					...
					const clientKey = stableKey
						? `openade/turn/start:${stableKey}`
						: requestKey;
					...
					const request = adapters
						...
						.then((result) => {
							...
							if (
								!currentRuntime ||
								currentRuntime.status === "starting" ||
			...
			server.register(
				...
				(params) => {
					...
					const requestKey = stableKey ?? createId();
					const clientKey = stableKey
						? `openade/review/start:${stableKey}`
						: requestKey;
					const existing = clientRequests.get(clientKey);
					if (existing) return existing.promise;
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/turn/interrupt", params, () => {
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/queued-turn/enqueue", params, () => {
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/queued-turn/reorder", params, () => {
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/queued-turn/cancel", params, () => {
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/task/environment/setup", params, () =>
						adapters.setupTaskEnvironment(taskEnvironmentSetupParams(params)),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/action/create", params, () =>
						adapters.createActionEvent(createActionEventParams(params)),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/action/stream/append", params, () =>
						adapters.appendActionStreamEvent(
							appendActionStreamEventParams(params),
						),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/action/complete", params, () =>
						adapters.completeActionEvent(completeActionEventParams(params)),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/action/error", params, () =>
						adapters.errorActionEvent(errorActionEventParams(params)),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/action/stopped", params, () =>
						adapters.stoppedActionEvent(stoppedActionEventParams(params)),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/action/reconcileRuntime", params, () =>
						adapters.reconcileActionEventRuntime(
							reconcileActionEventRuntimeParams(params),
						),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/action/execution/update", params, () =>
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation(
						...
						params,
						() =>
							adapters.addHyperPlanSubExecution(
								hyperplanSubExecutionAddParams(params),
							),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation(
						...
						params,
						() =>
							adapters.appendHyperPlanSubExecutionStreamEvent(
								hyperplanSubExecutionStreamAppendParams(params),
							),
					),
				{
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation(
						...
						params,
						() =>
							adapters.updateHyperPlanSubExecution(
								hyperplanSubExecutionUpdateParams(params),
							),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation(
						...
						params,
						() =>
							adapters.setHyperPlanReconcileLabels(
								hyperplanReconcileLabelsSetParams(params),
							),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/snapshot/create", params, () =>
						adapters.createSnapshotEvent(snapshotEventCreateParams(params)),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/comment/create", params, () =>
						adapters.createComment(commentCreateParams(params)),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/comment/edit", params, () =>
						adapters.editComment(commentEditParams(params)),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/comment/delete", params, () =>
						adapters.deleteComment(commentDeleteParams(params)),
					),
			...
			server.register(
				...
				(params) =>
					runIdempotentMutation("openade/task/metadata/update", params, () =>
						adapters.updateTaskMetadata(taskMetadataUpdateParams(params)),
					),
			...
			server.register(
				"openade/task/delete",
				(params) =>
					runIdempotentMutation("openade/task/delete", params, () =>
						adapters.deleteTask(taskDeleteParams(params)),
					),
			...
			server.register(
				"data/yjs/delete",
				(params) =>
					runIdempotentMutation("data/yjs/delete", params, () =>
						adapters.deleteDataDocument(dataDocumentIdParam(params)),
					),
				{ validateParams: validateWith(dataDocumentIdParam) },
			);
			const mcpSettings =
				adapters.readMcpServers &&
				adapters.replaceMcpServers &&
				adapters.upsertMcpServer &&
				adapters.deleteMcpServer
					? {
					...
					: null;
			if (mcpSettings) {
				server.register("openade/settings/mcpServers/read", () =>
					mcpSettings.readMcpServers(),
				);
				server.register(
			...
			const personalSettings =
				adapters.readPersonalSettings && adapters.replacePersonalSettings
					...
					: null;
			if (personalSettings) {
				server.register("openade/settings/personal/read", () =>
					personalSettings.readPersonalSettings(),
				);
				server.register(
					...
					(params) =>
						runIdempotentMutation(
							...
							params,
							() =>
								personalSettings.replacePersonalSettings(
									personalSettingsReplaceParams(params),
								),
						),
			...
			if (cronInstallState) {
				server.register(
					...
					(params) =>
						cronInstallState.readCronInstallState(
							cronInstallStateReadParams(params),
						),
				...
				server.register(
					...
					(params) =>
						runIdempotentMutation(
							...
							params,
							() =>
								cronInstallState.replaceCronInstallState(
									cronInstallStateReplaceParams(params),
								),
						),
...
export function publishOpenADECompanionEvent(
	server: RuntimeServer,
	event: OpenADERuntimeBridgeEvent,
): void {
	switch (event.type) {
		...
		case "working_tasks":
			for (const runtime of server.supervisor.list({
				...
				if (
					runtime.scope.ownerId &&
					event.taskIds.includes(runtime.scope.ownerId)
				) {
