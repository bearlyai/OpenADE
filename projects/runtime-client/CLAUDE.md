...
- WebSocket and local transports expose `requestWithOptions(..., { requestId })` for sanitized caller-provided JSON-RPC ids. Keep it payload-free and use it for log correlation, not for product idempotency.
