...
function setupDownloadLinks() {
  ...
  const links: Record<string, string> = {
    mac: "https://github.com/bearlyai/OpenADE/releases/download/v0.74.0/OpenADE-0.74.0-universal.dmg",
    linux:
      "https://github.com/bearlyai/OpenADE/releases/download/v0.74.0/OpenADE-0.74.0-arm64.AppImage",
    windows:
      "https://github.com/bearlyai/OpenADE/releases/download/v0.74.0/OpenADE-Setup-0.74.0.exe",
  }
