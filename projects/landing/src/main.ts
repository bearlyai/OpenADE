...
function setupDownloadLinks() {
  ...
  const links: Record<string, string> = {
    mac: "https://github.com/bearlyai/OpenADE/releases/download/v0.63.0/OpenADE-0.63.0-universal.dmg",
    linux:
      "https://github.com/bearlyai/OpenADE/releases/download/v0.63.0/OpenADE-0.63.0-arm64.AppImage",
    windows:
      "https://github.com/bearlyai/OpenADE/releases/download/v0.63.0/OpenADE-Setup-0.63.0.exe",
  }
