...
Runtime-backed SmartEditor file mentions must not run an empty fuzzy search just to warm the cache on editor mount. Search on actual user queries, and keep identical product fuzzy searches coalesced in `SmartEditorManager`.
